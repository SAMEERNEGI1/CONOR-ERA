        ...
        <div className="flex flex-col w-full">
          ...
          {!fileUrl && !isEditing && (
            ...
            >
              {content}
              {isUpdated && !deleted && (
                <span className="text-[10x] mx-2 text-zinc-500 dark:text-zinc-400">
                  (edited)
                </span>
              )}
            </p>
                    ...
                    <FormItem className="flex-1">
                      <FormControl>
                        <div className="relative w-full">
                            <Input disabled={isLoading} className="p-2 bg-zinc-200/90 dark:bg-zinc-700/75 border-none border-0 focus-visible:ring-offset-0 text-zinc-600 dark:text-zinc-200" placeholder="Edited message" {...field}/>
